...
/// </summary>
public class SetWorkSheetMoveToLast : SetBase
{
    #region constructor/s

    /// <summary>
    /// Initializes a new instance of the <see cref="SetWorkSheetMoveToLast"/> class.
    /// </summary>
    public SetWorkSheetMoveToLast()
    {
    ...
    private static ActionResult ExecuteImpl(IXlsxInput context, Stream input, ExcelPackage package, ExcelWorksheet worksheet)
    {
        ...
        try
        {
            worksheet.Workbook.Worksheets.MoveToEnd(worksheet.Name);
