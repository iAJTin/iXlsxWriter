...
/// Represents more brightness effect.
/// </summary>
public partial class XlsxMoreBrightnessEffect
{
    /// <summary>
    ...
    /// </returns>
    public override ImageAttributes Apply() => ImageHelper.GetImageAttributesFromEffect(EffectType.MoreBrightness);
}
