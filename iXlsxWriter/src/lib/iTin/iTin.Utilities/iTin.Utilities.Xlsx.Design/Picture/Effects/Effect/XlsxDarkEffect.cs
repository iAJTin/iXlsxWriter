...
/// Represents dark effect.
/// </summary>
public partial class XlsxDarkEffect
{
    /// <summary>
    ...
    /// </returns>
    public override ImageAttributes Apply() => ImageHelper.GetImageAttributesFromEffect(EffectType.Dark);
}
