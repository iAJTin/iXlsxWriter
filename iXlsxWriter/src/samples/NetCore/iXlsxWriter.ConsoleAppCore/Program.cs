...
class Program
{
    static void Main(string[] args)
    {
        ...
        ILogger logger = new Logger(Constants.AppName, [new FileLog(), new ColoredConsoleLog()]) { Deep = LogDeep.OnlyApplicationCalls, Status = LogStatus.Running };
        ...
        logger.Info("");
        logger.Info("> Shows how to insert a custom data table.");
        Sample27.Generate(logger, 25);
