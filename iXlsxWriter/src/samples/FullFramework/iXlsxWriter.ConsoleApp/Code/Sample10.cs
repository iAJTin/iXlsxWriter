...
/// <summary>
/// Shows how to insert an image from file and byte array.
/// </summary>
internal class Sample10
{
    public static void Generate(ILogger logger)
    {
        ...
        using var image1 = XlsxImage.FromFile(iTinPath.PathResolver("~/Resources/Sample-10/image-1.jpg"));
        using var image2 = XlsxImage.FromByteArray(File.ReadAllBytes(iTinPath.PathResolver("~/Resources/Sample-10/image-2.jpg")));
