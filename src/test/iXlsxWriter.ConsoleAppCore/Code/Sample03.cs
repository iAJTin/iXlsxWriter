...
namespace iXlsxWriter.Samples
{
    ...
    /// <summary>
    /// Shows the use of how creates a report with minicharts and conditional inserts
    /// </summary>
    internal class Sample03
    {
        ...
        public static void Generate(ILogger logger)
        {
            ...
            #region Sheet 2 > Insert Mini-Charts and conditional

            doc.Insert(new InsertMiniChart
            {
                SheetName = rawDataSheetName,
                Location = new XlsxStringRange { Address = "C33:C33" },
                MiniChart = new XlsxMiniChart
                {
                    ...
                    ChartAxes =
                    {
                        Horizontal =
                        {
                            Type = MiniChartHorizontalAxisType.Date
                        }
                    },
                    ChartType =
                    {
                    ...
                    ChartRanges =
                    {
                        Axis = new XlsxStringRange {Address = "B3:B32"},
            ...
            }).Insert(new InsertText
            {
                SheetName = rawDataSheetName,
                Style = CellStylesTable["SummaryLabel"],
                Location = new XlsxPointRange {Column = 8, Row = 1},
                Data = reportData.ConfiguracionInforme.TituloInforme
            }, canInsert: false).Insert(new InsertText
            {
                SheetName = rawDataSheetName,
                Style = CellStylesTable["SummaryLabel"],
                Location = new XlsxPointRange { Column = 8, Row = 2 },
                Data = reportData.ConfiguracionInforme.ColorMedia
            }, canInsert: true);
            ...
            var saveResult = result.Result.Action(new SaveToFile { OutputPath = "~/Output/Sample03/Sample-03" });
            ...
            logger.Info("     > Path: ~/Output/Sample03/Sample-03.xlsx");
