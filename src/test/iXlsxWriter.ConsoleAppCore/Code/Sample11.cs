...
namespace iXlsxWriter.Samples
{
    ...
    internal class Sample11
    {
        ...
        public static void Generate(ILogger logger)
        {
            ...
            #region Copy range(s) in sheet 2
            ...
            var saveResult = result.Result.Action(new SaveToFile { OutputPath = "~/Output/Sample11/Sample-11" });
            ...
            logger.Info("     > Path: ~/Output/Sample11/Sample-11.xlsx");
