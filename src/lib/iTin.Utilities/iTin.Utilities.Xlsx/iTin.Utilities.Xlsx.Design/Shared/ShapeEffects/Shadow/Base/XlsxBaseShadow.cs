...
namespace iTin.Utilities.Xlsx.Design.Shared
{
    ...
    public abstract partial class XlsxBaseShadow : ICombinable<XlsxBaseShadow>, ICloneable
    {
        ...
        #region [protected] XlsxBaseShadow(): Initializes a new instance of this class
        /// <summary>
        ...
        #region (object) ICombinable<XlsxBaseShadow>.Combine(XlsxBaseShadow): Combines this instance with reference parameter
        /// <summary>
        ...
        #region [public] (KnownShadowType) Type: Gets a value indicating shadow type
        /// <summary>
        ...
        public KnownShadowType Type
        {
            get
            {
                ...
                switch (shadowType)
                {
                    case "XlsxInnerShadow":
                        return KnownShadowType.Inner;

                    case "XlsxPerspectiveShadow":
                        return KnownShadowType.Perspective;

                    default:
                    case "XlsxOuterShadow":
                        return KnownShadowType.Outer;
                }
            }
        }
        #endregion
        ...
        #region [public] (int) Angle: Gets or sets the preferred shadow angle
        /// <summary>
        ...
        #region [public] (int) Blur: Gets or sets the preferred blur value
        /// <summary>
        ...
        #region [public] (int) Offset: Gets or sets the shadow distance
        /// <summary>
        ...
        #region [public] (int) Transparency: Gets or sets the shadow transparency value
        /// <summary>
        ...
        #region [public] (XlsxBaseShadow) Clone(): Clones this instance
        /// <summary>
        ...
        #region [public] {virtual} (void) ApplyOptions(XlsxBaseShadowOptions): Apply specified options to this font
        /// <summary>
        ...
        #region [public] {virtual} (void) Combine(XlsxBaseShadow): Combines this instance with reference parameter
        /// <summary>
        /// Combines this instance with reference parameter.
        /// </summary>
