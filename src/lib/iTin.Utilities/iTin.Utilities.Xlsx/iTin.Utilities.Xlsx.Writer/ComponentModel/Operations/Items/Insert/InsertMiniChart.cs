...
namespace iTin.Utilities.Xlsx.Writer.ComponentModel
{
    ...
    public class InsertMiniChart : InsertLocationBase
    {
        ...
        #region [public] InsertMiniChart(): Initializes a new instance of the class
        /// <summary>
        ...
        #region [public] (XlsxMiniChart) MiniChart: Gets or sets a reference to minichart configuration
        /// <summary>
