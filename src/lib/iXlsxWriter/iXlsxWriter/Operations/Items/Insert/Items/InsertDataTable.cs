...
public class InsertDataTable : InsertLocationBase
{
    ...
    public override ActionResult Execute(IXlsxInput context, Stream input, ExcelPackage package, ExcelWorksheet worksheet)
    {
        ...
        return ExecuteImpl(context, input, package, worksheet, Data, Location);
    }
    ...
    private static ActionResult ExecuteImpl(IXlsxInput context, Stream input, ExcelPackage package, ExcelWorksheet worksheet, DataTable data, XlsxBaseRange location)
    {
        ...
        try
        {
            ...
            worksheet.Cells[locationAddress.ToString()].LoadFromDataTable(data, true);
