...
namespace iTin.Utilities.Xlsx.Design.Picture
{
    ...
    public sealed class XlsxImageConfig : ICloneable
    {
        ...
        /// </summary>
        public static readonly XlsxImageConfig Default = new XlsxImageConfig();
        #endregion

        #region constructor/s

        #region [public] XlsxImageConfig(): Initializes a new instance of the class
        /// <summary>
        ...
        #region [public] (XlsxImageConfig) Clone(): Clones this instance
        /// <summary>
