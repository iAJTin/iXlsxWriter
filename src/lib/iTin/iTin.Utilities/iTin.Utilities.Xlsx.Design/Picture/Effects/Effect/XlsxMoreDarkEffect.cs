...
namespace iTin.Utilities.Xlsx.Design.Picture
{
    ...
    /// Represents more dark effect.
    /// </summary>
    public partial class XlsxMoreDarkEffect
    {
        /// <summary>
        ...
        /// </returns>
        public override ImageAttributes Apply() => ImageHelper.GetImageAttributesFromEffect(EffectType.MoreDark);
    }
}
