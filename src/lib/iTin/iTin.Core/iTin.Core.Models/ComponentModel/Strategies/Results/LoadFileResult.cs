...
public class LoadFileResult : ResultBase<LoadFileResultData>
{
    ...
    /// </returns>
    public new static LoadFileResult FromException(Exception exception) => 
    ...
    /// A new <see cref="LoadFileResult"/> instance for specified exception.
    /// </returns>
    public new static LoadFileResult FromException(Exception exception, LoadFileResultData result) =>
        new()
        {
            Result = result,
            Success = false,
