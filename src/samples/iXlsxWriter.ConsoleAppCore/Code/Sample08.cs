...
namespace iXlsxWriter.Samples
{
    ...
    internal class Sample08
    {
        ...
        public static void Generate(ILogger logger)
        {
            ...
            #region Evaluate operation(s)

            if (!shadowsInsertResult.Success)
            {
                logger.Info("   > Error while creating shapes with shapes");
            ...
            var saveResult = result.Result.Action(new SaveToFile { OutputPath = "~/Output/Sample08/Sample-08" });
            ...
            logger.Info("     > Path: ~/Output/Sample08/Sample-08.xlsx");
